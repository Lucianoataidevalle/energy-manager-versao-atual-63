...
export const useInvoiceForm = (
  ...
  const [formData, setFormData] = useState<InvoiceFormData>({
    ...
    custoDemandaUltrapassagemForaPonta: "",
    custoDemandaUltrapassagemPonta: "",
  ...
  useEffect(() => {
    if (editingInvoice) {
      setFormData({
        ...
        custoDemandaUltrapassagemForaPonta: editingInvoice.custoDemandaUltrapassagemForaPonta?.toString() || "",
        custoDemandaUltrapassagemPonta: editingInvoice.custoDemandaUltrapassagemPonta?.toString() || "",
  ...
  const handleSubmit = async () => {
    try {
      const invoiceData = {
        ...
        custoDemandaUltrapassagemForaPonta: parseFormattedNumber(formData.custoDemandaUltrapassagemForaPonta),
        custoDemandaUltrapassagemPonta: parseFormattedNumber(formData.custoDemandaUltrapassagemPonta),
